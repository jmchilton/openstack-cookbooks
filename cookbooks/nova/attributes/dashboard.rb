...
default[:nova][:dashboard][:dashboard_repo] = "https://github.com/4P/openstack-dashboard.git"
default[:nova][:dashboard][:django_nova_dir] = File.join(node[:nova][:dashboard][:deploy_dir], "django-openstack")
default[:nova][:dashboard][:django_nova_syspanel_dir] = File.join(node[:nova][:dashboard][:deploy_dir], "django-nova-syspanel")
